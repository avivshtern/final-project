...
public void addClient (String firstName, String lastName, String cityName, String streetName, int streetNum, String phoneNumber)
{
	numOfClients++;
	Date currentDate=new Date();
	Client currentClient = new Client(firstName, lastName, cityName, streetName, streetNum, phoneNumber, numOfClients, currentDate);
